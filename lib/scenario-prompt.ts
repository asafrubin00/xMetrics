...
Keep companyContext between 60 and 90 words. Keep each beat body between 140 and 180 words, each memberMoment between 30 and 45 words, and each option description between 40 and 60 words. Concision is a quality requirement, not a limit to fill: cut hedging, restatement and scene-setting rather than substance.
